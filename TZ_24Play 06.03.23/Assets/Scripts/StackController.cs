...
public class StackController : MonoBehaviour
{
    ...
    public void IncreaseNewBlock(GameObject _gameObject)
    {
        ...
        _gameObject.transform.position = new Vector3(lastBlockObject.transform.position.x, lastBlockObject.transform.position.y - 1f, lastBlockObject.transform.position.z);
